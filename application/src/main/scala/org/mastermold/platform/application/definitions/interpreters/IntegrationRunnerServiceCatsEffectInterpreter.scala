...
/**
  ...
  */
class IntegrationRunnerServiceCatsEffectInterpreter[F[_]: Async, InputEvent <: Event[_], DTO] (loggingService: LoggingServiceAlgebra [F, String])extends IntegrationRunnerServiceAlgebra[F, InputEvent, DTO] {
